...
export default function ContactSection({
  ...
  return (
    <div
      className="w-full px-10 py-20 bg-bg-mid flex justify-center"
      ref={contactSectionRef}
    >
      <div className="w-full max-w-3xl flex flex-col md:flex-row rounded-md overflow-hidden">
        <div className="w-full md:w-96 p-6 bg-bg-dark">
          <h3 className="text-2xl font-semibold text-shadow mb-5">
            Reach out!
          </h3>
          <p>
            I{"'"}d love to help bring your vision to life! Please let me know
            if you have a package in mind, or if you need help deciding.
          </p>
        </div>
        <div className="w-full bg-bg-light p-6">
          <form onSubmit={handleSubmit}>
            <fieldset
              ...
              className="flex flex-col gap-3 md:py-4"
            >
              <input
              ...
              {submitted && (
                <div
                  id="toast-success"
                  className={`w-full flex items-center p-4 mb-4 text-gray-400 rounded-lg shadow bg-bg-dark`}
                  role="alert"
                >
                  ...
                  <div className="ml-3 text-sm font-normal">
                    Form sent successfully. I will get back to you as soon as
                    possible!
                  </div>
                </div>
              )}
              {error && (
                ...
                >
                  ...
                  <div className="ml-3 text-sm font-normal">
                    ...
                    <a
                      href="mailto:rosewald2003@gmail.com"
              ...
              <button
                type="submit"
                className="mt-2 bg-bg-mid font-semibold rounded-md p-2 hover:bg-c-green hover:text-shadow hover:text-bg-dark transition-all"
              >
                Submit
              </button>
            </fieldset>
